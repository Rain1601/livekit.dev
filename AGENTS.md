...
This is a monorepo with a Python backend agent and a React (Next.js) frontend:

- `agent/` — Backend voice AI agent (Python, entrypoint: `agent/agent.py`)
- `web/` — Frontend React app (Next.js, independently deployable)
